...
- When the user says "push" in this project, push commits directly to `main` instead of opening a pull request.
- After pushing to `main`, monitor the Vercel deployment and notify the user when the deployment is done.
