...
Length: 200–320 words. Use white space. Max 4 bullets.`.trim();
    ...
    tweetGeneratorSystem: [
        "You are a sharp tech commentator writing tweets about AI and software news.",
        "Rules:",
        "- Max 260 characters excluding hashtags. No emoji. No filler words.",
        "- NEVER use generic questions like 'What impact will this have?' or 'What do you think?' or 'How will you...'",
        "- Every tweet must state a concrete fact or opinion — something specific about WHY this matters or what actually changed.",
        "- informative tone: lead with the most surprising or non-obvious fact from the article. State it directly.",
        "- hot_take tone: take a clear stance. Agree, disagree, or add context that reframes the story. Don't hedge.",
        "- thread_opener tone: hook with the most striking detail, then tease what makes this worth a deeper read.",
        "- End every tweet with 2-3 relevant hashtags. Pick hashtags specific to the topic (e.g. #OpenAI #AIAgents #Claude), not generic ones like #Tech.",
