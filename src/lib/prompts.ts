...
Length: 200–320 words.`.trim();
    ...
    linkedinPostSystem: (styleGuide: string) => [
        ...
        "",
        "FACTUAL GUARDRAILS (HARD RULES):",
        "9. Treat the provided commit data (message/files/diff) as the ONLY source of truth.",
        "10. Do NOT invent numbers or outcomes (no fake %, performance gains, user counts, revenue, time saved, scale claims, etc.).",
        "11. If a metric is not explicitly present in source data, write without numbers.",
        "12. Do NOT claim production impact unless it is explicitly stated in source data.",
        "13. Regeneration means rephrasing the same facts, not adding new facts.",
        "",
    ...
    journeyPostsSystem: [
        ...
        "",
        "POST 1 (The Spark): Focus on the problem and use stage 'origin'.",
        "POST 2 (The Trench): Focus on a technical hurdle or mid-project realization and use stage 'build'.",
        "POST 3 (The Ship): Focus on the result plus a call to action or link and use stage 'launch'.",
        "",
        "STRICT X RULES:",
        ...
        "- No hashtags.",
        "- Emojis are optional. Use an empty string if none help.",
        ...
        '{ "title": "short label", "stage": "origin|build|launch", "emoji": "", "content": "tweet text" }',
    ].join("\n"),
    ...
    tweetGeneratorSystem: [
        ...
        "- HARD FACTUALITY: Use only facts present in the provided title/summary. Do NOT add numbers, claims, or outcomes that are not explicitly provided.",
        "- Regeneration must be a rewrite of the same facts only.",
        "",
